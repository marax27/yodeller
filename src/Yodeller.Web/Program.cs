...
builder.Services.AddTransient<IDiskSpaceEnvironmentCheck, DumbDiskSpaceEnvironmentCheck>();
builder.Services.AddTransient<IApplicationAvailableEnvironmentCheck, DumbApplicationAvailableEnvironmentCheck>();
